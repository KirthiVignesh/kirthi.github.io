...
const LeftBar = () => {
  ...
  const WebList = () => (
    <div>
      <a href="https://github.com/KirthiVignesh/Nimmadhi">
      ...
      <a href="https://github.com/KirthiVignesh/onlook">
        <div className="ml-12 flex items-center hover:cursor-pointer hover:bg-opacity-80 hover:bg-[#2b2a2a] w-60">
          <img
            src={Flutter}
            alt="TS Icon"
      ...
      <a href="https://github.com/KirthiVignesh/skanmed">
      ...
      <div>
        ...
        <div className="absolute inset-x-0 bottom-10 ">
          <div className="flex px-6 space-x-7">
            <a href="https://www.github.com/KirthiVignesh">
              <img
                src={GitLogo}
                alt="Git Logo"
            ...
            <a href="https://www.linkedin.com/in/kirthi-govindarajan/">
              <img
                src={LinkedinLogo}
                alt="Linkedin Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a href="mailto:kirthivignesh.kvg@protonmail.com">
              <img
                src={MailLogo}
                alt="Mail Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
