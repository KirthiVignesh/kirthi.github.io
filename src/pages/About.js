...
const Flutter = require("../assets/logos/Flutter.png");
const Dart = require("../assets/logos/Dart.png");
    ...
    >
      <div>
        ...
        <div className="text-[#a2aabc] text-lg mt-5">
          <code>
          Seeking a beginner role to enhance and explore my technical knowledge. I'm currently pursuing B.E Computer Science and Engineering from Sri Eshwar College of Engineering. 
          </code>
          <br />
          <br />
          <code>These are some of the technologies that I have worked on recently:</code>
